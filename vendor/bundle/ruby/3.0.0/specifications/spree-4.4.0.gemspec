...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<spree_api>.freeze, ["= 4.4.0"])
    s.add_runtime_dependency(%q<spree_cli>.freeze, ["= 4.4.0"])
  else
    s.add_dependency(%q<spree_core>.freeze, ["= 4.4.0"])
    s.add_dependency(%q<spree_api>.freeze, ["= 4.4.0"])
    s.add_dependency(%q<spree_cli>.freeze, ["= 4.4.0"])
  end
end
